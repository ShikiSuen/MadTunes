...
public actor Debouncer {
  ...
  public func debounce(
    ...
    if keepFirstAttemptInstead {
      ...
      // Phase 167: Leading-edge lock prevents subsequent trailing-edge calls
      ...
      // Phase 167: Suppress trailing-edge calls while a leading-edge exclusive
    ...
    task = Task { @MainActor [weak self] in
      ...
      await self.clearLeadingEdgeLock()
