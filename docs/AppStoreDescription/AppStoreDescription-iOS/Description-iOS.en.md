# App Store Description - MadTunes iOS (English)
...
As a music creator, you need playback tools that accurately reveal mixing details. Validated through over 100 rigorous tests, only the system-native AVPlayer (from AVFoundation Framework) ensures optimal audio quality on iOS. MadTunes builds upon this foundation, faithfully presenting original audio without additional sound processing, letting you hear the true studio-grade sound.
...
• **Powerful Keyboard Navigation** — Full keyboard support on iPad, from grid navigation to queue management without mouse;
...
• **Optimized for Apple Devices** — validated through over 100 tests to ensure best audio quality on iOS;
